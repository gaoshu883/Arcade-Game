...
var Engine = function(global) {
    ...
    function reset() {
        ...
        ctx.strokeText("BE CAREFUL!", canvas.width / 2, 200);
        ctx.strokeText("THEY ARE BAD!", canvas.width / 2, 250);
    }
